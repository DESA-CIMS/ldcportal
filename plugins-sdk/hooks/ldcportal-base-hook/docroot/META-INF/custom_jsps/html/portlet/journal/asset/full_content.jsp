...
Map<String, String> jargonMap = LDCJargonLocalServiceUtil.getAllLDCJargonMapByLocale(scopeGroupId, locale);
%>

<div class="journal-content-article">
	<%= LDCJargonLocalServiceUtil.tooltipJargon(articleDisplay.getContent(), jargonMap, 
