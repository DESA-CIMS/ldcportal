				...
				<ul class="category-portlets">
					...
					for (int i = 0; i < portlets.size(); i++) {
						...
						if (portlet.isActive() && !portlet.isInstanceable()) {
							...
							if (portletId.equals(PortletKeys.SITES_ADMIN)) {
								if(!PortletPermissionUtil.contains(permissionChecker, 0, plid, portletId, ActionKeys.ACCESS_IN_CONTROL_PANEL, true)) {
									portlets.remove(i);
									continue;
								}
							}
